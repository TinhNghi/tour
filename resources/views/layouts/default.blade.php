...
<head>
    ...
    <title>Attract Tour | @yield('title', 'Trang chủ')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('storage/images/logo.jpg') }}"
            ...
            <ul class="navbar-nav">
                ...
                @if (auth()->user()->chuc_vu == 1)
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="{{ route('admin.index') }}" class="nav-link">Trang quản trị Admin</a>
                    </li>
                @endif
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('menu.index') }}" class="nav-link">Trang chủ</a>
                </li>
            </ul>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Tour.io</a>.</strong>
            All rights reserved.
